...
axis(side = 1, 
     pos = 0, 
     at = seq(2008, 2020, by = 3),
     labels = seq(2008, 2020, by = 3))
# вертикальная ось
axis(side = 2, 
     pos = 0, 
     at = seq(0, 350000, by = 50000),
     labels = seq(0, 350000, by = 50000),
     las = 2)
# стрелки на концах осей
arrows(x0 = c(0, 2020), y0 = c(350000, 0),
       x1 = c(0, 2025), y1 = c(400000, 0))
